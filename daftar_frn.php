					...
					<div class="login_form_inner">
                        ...
                        <?php
                                    if(isset($_POST['save'])){
                                        ...
                                        $email = $_POST['email'];
                                        $web = $_POST['web'];
										// $sql="INSERT INTO `tb_frn`(`frn_nama`, `frn_username`, `frn_password`, `frn_telpon`, `frn_email`, `frn_web`,`frn_gambar`) VALUES ('$nama','$username','$pass','$telpon','$email','$web','$gambarniq')";
										// echo $sql;
										// exit;
