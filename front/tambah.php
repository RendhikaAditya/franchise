                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="row contact_form" action="#" method="post" novalidate="novalidate" enctype="multipart/form-data">
                            ...
                            <label>Nama Waralaba</label>
                                <select  class="country_select" name="nama">
                            ...
                            <div class="col-md-12 form-group">
                            <label>Gambar</label>    
                            <label class="file" style="100%">
                                ______________________________________________________________________________________________________________._______________________--_____________________________________
                                    <input type="file" name="gambar" aria-label="File browser example">
                                    <span class="file-custom"></span>
                                </label>                       
                            </div>  
                            <div class="col-md-12 form-group">
                                <button name="save" class="primary-btn rounded" style="width:100%">Tambah</button>
                            </div>
                        </form>
                        <?php
                                    if(isset($_POST['save'])){
