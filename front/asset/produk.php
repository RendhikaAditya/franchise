				...
				<section class="lattest-product-area pb-40 category-list">
					<div class="row">
						...
						<?php 
							...
							$data=$koneksi->query("SELECT * FROM `tb_info` LEFT JOIn tb_kategori ON tb_info.kategori_id=tb_kategori.kategori_id");
							while($isi=$data->fetch_object()){
						?>
						<div class="col-lg-4 col-md-6" >
							<div class="single-product">
								<img class="img-fluid" style="height:180px" src="admin/asset/gambar/<?php echo $isi->info_gambar ?>" alt="">
