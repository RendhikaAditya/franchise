                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto">
						...
						<li class="nav-item submenu dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Daftar</a>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="nav-item">
                            <li class="nav-item"><a href="#" class="cart"><img src="admin/asset/gambar/user.png" style="width:40px; " class="border border-danger rounded-circle"></a></li>
